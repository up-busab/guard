...
#echo "SAM I SEE WHAT YOU ARE DOING!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"

if [ -f /home/pi/.guardian/deducted ];
then
    duration=$(cat /home/pi/.guardian/deducted)
    if [ "$duration" -gt 60 ];
    then
        rm -f /home/pi/.guardian/deducted
        command2=$command" & sleep "$duration"; reboot"
        # run command
        eval $command2
    fi
fi
